using Automation.Domain.Dtos;
using Automation.Domain.Dtos.Request.Department;
using Automation.Domain.Dtos.Response;
using Automation.Domain.Interfaces.Services;
