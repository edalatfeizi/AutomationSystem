    ...
    public partial class Add_Entities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MailNumber = table.Column<int>(type: "int", nullable: false),
                    From = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    To = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Subject = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Body = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImediacyType = table.Column<int>(type: "int", nullable: false),
                    ...
                    ForwardedFrom = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Mails_Mails_ForwardedFrom",
                        column: x => x.ForwardedFrom,
                        principalTable: "Mails",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Mails_Mails_RepliedTo",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MailAttachments_Attachments_AttachmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MailAttachments_AttachmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Mails_ForwardedFrom",
                table: "Mails",
                column: "ForwardedFrom");

            migrationBuilder.CreateIndex(
                name: "IX_Mails_RepliedTo",
                table: "Mails",
                column: "RepliedTo");
        }
